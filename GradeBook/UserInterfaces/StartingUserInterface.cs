...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (parts.Length != 4)
            {
                Console.WriteLine("Command not valid, Create requires a name and type of gradebook, Command not valid, Create requires a name, type of gradebook, if it's weighted (true / false)");
                return;
            }
            var name = parts[1];
